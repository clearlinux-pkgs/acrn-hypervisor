...
Version  : 2019w27.4.140000p
Release  : 219
URL      : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2019w27.4-140000p.tar.gz
Source0  : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2019w27.4-140000p.tar.gz
...
Patch1: 0001-makefile-fix-parallel-build.patch
Patch2: 0002-tools-acrn-manager-fix-ACRN-manager-headers-install.patch
...
%prep
%setup -q -n acrn-hypervisor-acrn-2019w27.4-140000p
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562604746
