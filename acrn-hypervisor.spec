...
Version  : 2018w50.2.140000p
Release  : 128
URL      : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2018w50.2-140000p.tar.gz
Source0  : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2018w50.2-140000p.tar.gz
...
%prep
%setup -q -n acrn-hypervisor-acrn-2018w50.2-140000p
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1544539375
