...
Version  : 2018w31.1.140000p
Release  : 55
URL      : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2018w31.1-140000p.tar.gz
Source0  : https://github.com/projectacrn/acrn-hypervisor/archive/acrn-2018w31.1-140000p.tar.gz
...
Patch1: 0001-DM-fix-make-install-issue-in-auto-boot-UOS-service.patch
...
%prep
%setup -q -n acrn-hypervisor-acrn-2018w31.1-140000p
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1533049622
